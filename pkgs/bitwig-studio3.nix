...
stdenv.mkDerivation rec {
  ...
  buildInputs = with xorg; [
    alsaLib cairo freetype gdk-pixbuf glib gtk3 libxcb xcbutil xcbutilwm zlib libXtst libxkbcommon_7 pulseaudio libjack2 libX11 libglvnd libXcursor stdenv.cc.cc.lib
  ];
