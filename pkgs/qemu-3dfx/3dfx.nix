{ lib, stdenv, fetchFromGitHub, gnused, unixtools, perl, gnumake, which, fetchurl, writeScriptBin, pkgsCross }:

let
  qemu-3dfx = import ./common.nix { inherit fetchFromGitHub writeScriptBin stdenv lib; };
